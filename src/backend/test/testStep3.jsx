...
import { siteVisitStep } from "../services/complaintService";

/**
 * testStep3 -
 */
export const testStep3 = ({ leadId = "V0OsujXIz3XNkyWU5Voe", onClose }) => {
  ...
  const handleUpdateLead = async () => {
    ...
    try {
      ...
      await siteVisitStep(leadId, payload);
      alert("✅ STEP-3 executed successfully");
      if (onClose) onClose();
    } catch (err) {
